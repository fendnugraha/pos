...
class Home_model extends CI_Model
{
    ...
    public function saldoAwal($tanggal)
    {
        ...
        FROM deposit
        WHERE status = 'Out' and metode=0 and date(waktu) BETWEEN '0000-00-00' and '$dateAwal' or status = 'Out' and metode=3 and date(waktu) BETWEEN '0000-00-00' and '$dateAwal'")->row_array();
